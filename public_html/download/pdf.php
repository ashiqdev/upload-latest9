    ...
    <div id="main_content">
      ...
      <div class="">
        ...
        <section class="download">
          <div class="container">
            <div class="row">
              ...
              <div class="download-from-wrapper">
                  <div class="download-from-inner pdf-inner">
                    <h2 class="title">
          ...
          <div class="download-banner pdf-banner">
            <div class="pdf-container">
              <iframe
                src="https://www.soundczech.cz/temp/lorem-ipsum.pdf"
                width="100%"
                height="100%"
                frameBorder="0"
              >
                ...
                view it:
                <a href="https://www.soundczech.cz/temp/lorem-ipsum.pdf"
                  >Download PDF</a
                ></iframe
              >
            </div>
