          ...
          >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-nav 5s ease-in-out infinite;
                  font-size: 67px;
                "
                >photo_library</span
              >
              ...
              <div class="col-lg-7">
                <div class="download-from-wrapper">
                  <div class="download-from-inner">
                    <h2 class="title">
                      MyFile.<span style="color: #1ea6ff">txt</span>
                    </h2>
                    ...
                    <div class="file-info-wrapper">
                      <div class="stat">
                        <span>
                          <!-- <i
                            class="material-icons stat-icons"
                            data-icon="crop_free"
                          ></i> -->
                          <img src="../icons/085-server.svg" alt="" />
                        </span>
                        <div>
                          <h2>2.42MB</h2>
                          <p>Size</p>
                      ...
                      <div class="stat">
                        <span>
                          <!-- <i
                            ...
                            data-icon="schedule"
                          ></i> -->
                          <img src="../icons/017-clock.svg" alt="" />
                        </span>
                        <div>
                          <h2>2 Minutes Ago</h2>
                          <p>Uploaded</p>
                      ...
                      <div class="stat">
                        <span>
                          <!-- <i
                            ...
                            data-icon="article"
                          ></i> -->
                          <img src="../icons/028-document.svg" alt="" />
                        </span>
                        <div class="stat-info">
                          <h2>Txt</h2>
                          <p>File Type</p>
                      ...
                      <div class="stat">
                        <span>
                          ...
                          ></i> -->
                          <img src="../icons/042-fullscreen.svg" alt="" />
                        </span>
                        <div>
                          <h2>1920 X 1080</h2>
                          <p>Resolution</p>
                      ...
                      <div class="stat">
                        <span>
                          <!-- <i
                            ...
                            data-icon="fullscreen"
                          ></i> -->
                          <img src="../icons/053-layer.svg" alt="" />
                        </span>
                        <div>
                          <h2>243</h2>
                          <p>Words</p>
                      ...
                      <div class="stat">
                        <span>
                          <!-- <i
                            ...
                            data-icon="fullscreen"
                          ></i> -->
                          <img src="../icons/049-keyboard.svg" alt="" />
                        </span>
                        <div>
                          <h2>41</h2>
                          <p>Characters</p>
          ...
          <section class="featured-eight">
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-download 5s ease-in-out infinite;
                  font-size: 37px;
                "
                >folder</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-download 9s ease-in-out infinite;
                  font-size: 51px;
                "
                >photo</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-left-download 9s ease-in-out infinite;
                  font-size: 42px;
                "
                >inventory_2</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-download 7s ease-in-out infinite;
                  font-size: 30px;
                "
                >markunread</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-download 4s ease-in-out infinite;
                  font-size: 41px;
                "
                >insert_drive_file</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-left-download 6s ease-in-out infinite;
                  font-size: 52px;
                "
                >picture_as_pdf</span
              >
            ...
            >
              <span
                class="material-icons"
                style="
                  animation: icon-up-download 10s ease-in-out infinite;
                  font-size: 67px;
                "
                >photo_library</span
              >
