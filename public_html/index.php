...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-wrapper">
      ...
      >
        <div class="drop-area-child">
          ...
          <!-- <div class="fileIcon-wrapper">
            <div class="fileIcon-container">
              <div class="fileIcon">
                ...
                <span
                  class="material-icons"
                  style="font-size: 54px; color: #fff;  filter: drop-shadow(0.6rem 0.6rem 1rem rgba(100, 116, 139, 0.8));"
                  >description</span
                >
              </div>
            </div>
          ...
          <!-- 
          <div class="fileIcon-wrapper-latest">
            <i class="material-icons arrow-icon" data-icon="arrow_circle_down"></i>
          </div> -->
          ...
          <div class="tabset--wrapper">
            <div class="content-slider" data-active-tab="tab-1">
              <!-- 1 -->
              <div
                class="upload-border-file tabset--section tab-file-section"
        ...
        function addByAjaxCall() {
          $.ajax({
            ...
            success: function (data) {
              ...
              // setTimeout(() => {
              //   $('.your-uploads').css('opacity', '0');
              //   $('.fileIcon-wrapper-latest i').css('opacity', '1');

              //   setTimeout(() => {

              //     $('.fileIcon-wrapper-latest i').css('opacity', 1).slideDown('slow').animate(
    ...
    <script src="./plugins/notification-manager/notification-manager.js"></script>
    <script src="./js/main.js?v=123233.332322532223.4224222221.222531"></script>
  </body>
</html>
