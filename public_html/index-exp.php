      ...
      >
        <div class="drop-area-child">
          ...
          <div class="tabset--wrapper">
            <div class="content-slider" data-active-tab="tab-1">
              <!-- 1 -->
              <div
              ...
              >
                <div
                  ...
                  style="padding-bottom: 10px; color: #4c9ca2; margin-top: 15px"
                >
              ...
              <!-- 3 -->
              <div
                class="upload-border-file tabset--section cam-slider-section"
              ...
              >
                ...
                <div class="image-cap-click-wrapper" style="display: none">
                  <div class="pause-icon-wrapper" id="image-pause">
                    <img src="./icons/074-play.svg" alt="" />
                    <p>PAUSE</p>
                  </div>
