...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./style-again.css?v=<?php echo time(); ?>" />
  ...
  <body>
    ...
    <div class="main-wrapper">
          ...
          <div class="blue-rectangle" style="position: relative">
            ...
            <div class="lower-container">
              ...
              <div class="password-card animated-icon">
                <img src="./icons/073-padlock.svg" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        "
      >
        <div class="button-group toggle-button-group blue">
          <div class="active">
            <!-- <span class="material-icons"> cloud_upload </span> -->
            <img src="./icons/cloud-white.svg" alt="">
          </div>
          <div>
            <img src="./icons/mic-white.svg" alt="">
          </div>
          <div>
            <div>
          ...
          <div>
            <div>
              <img src="./icons/camera-white-video.svg" alt="">
            </div>
          </div>
        </div>
        ...
        <div class="upload-border" style="text-align: center">
          <div
            ...
            style="padding-bottom: 10px; color: #4c9ca2"
          >
            Drag & Drop files here to upload
          </div>
          <button class="browseButton">Browse Files</button>
          <style>
            .browseButton {
              padding: 15px;
        ...
        <div class="file-main" style="display: none">
          <h2 style="text-align: center; color: grey; padding: 30px">
            ...
            <div class="afterUpload-Container">
              <div class="left-side">
                <div class="success-message">
                  ...
                  <p style="width: 105%">
                    If you would like to edit your file in the future, then save
                    the edit link in a safe place (don't share it with anyone
                    else).
                  </p>
                </div>
              </div>
            ...
            <div class="progress-wrapper">
              <div class="progress-container">
                <div class="pause-icon">
                  <button class="pause-btn" style="border: 0; background: none">
                    <span
          ...
          <div class="col-lg-6">
            <div class="editor-content color-two">
              ...
              >
                ...
                <a
                  href="#"
                  class="pix-btn color-two animatable pixFadeUp"
                  data-wow-delay="0.9s"
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="pixsass-icon-box-content">
                ...
                > -->
                  <img src="./icons/077-right-arrow.svg" alt="right arrow" />
                </a>
        ...
        <div class="countup-wrapper">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="fun-fact animatable pixFadeUp" data-wow-delay="0.3s">
                <div class="counter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div
                class="fun-fact color-two animatable pixFadeUp"
                data-wow-delay="0.5s"
              >
                <div class="counter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div
                class="fun-fact color-three animatable pixFadeUp"
                data-wow-delay="0.7s"
              >
                <div class="counter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div
                class="fun-fact color-four animatable pixFadeUp"
                data-wow-delay="0.9s"
              >
                <div class="counter">
                ...
                <div class="historys">
                  ...
                  <div class="history__list">
                    <div class="history-info">
                      ...
                      <div class="info">
                        <h4 class="history-title"><a href="#">home.gif</a></h4>
                      </div>
                    </div>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="dateTimedModalLabel"
      aria-hidden="true"
      style="z-index: 101"
    >
      <div
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body date-time-modal">
                    ...
                    <div class="content">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="datepicker">
                          <input class="" placeholder="MM/DD/YYYY" /><span
                            class="input-group-append input-group-addon"
                            ><span class="input-group-text">
                              <i
                                class="material-icons date-icon input-prefix"
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group time" id="timepicker">
                          <input class="" placeholder="HH:MM AM/PM" /><span
                            class="input-group-append input-group-addon"
                            ><span class="input-group-text"
                              ><i
                                class="material-icons date-icon input-prefix"
    ...
    <script>
      ...
      $('html').bind('dragenter', function (e) {
        ...
        if (
          ...
          $('.upload-border').addClass('drag-in-uploader');
          // scroll to top
          // playIntroAnimation();
      ...
      $('html').bind('dragleave', function (e) {
        ...
        timeout = setTimeout(function () {
          if (!showDrag) {
            ...
            $('.upload-border').removeClass('drag-in-uploader');
          }
        }, 200);
      });
